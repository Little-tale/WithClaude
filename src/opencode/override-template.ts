export function bundledOverrideTemplate(): string {
  return [
    ...
    "  //",
    "  // To change the default Gemini CLI alias for Gemini workflow roles:",
    "  // \"geminiCli\": { \"auto\": \"flash\" }",
    "  //",
    "  // Advanced: override a specific Gemini role only:",
    "  // \"geminiCli\": { \"roles\": { \"reviewGemini\": { \"model\": \"pro\" } } }",
    "  //",
